              ...
              <tbody>
                ...
                {avisos.map((aviso) => (
                  <tr key={aviso.id} style={{ opacity: aviso.ativo ? 1 : 0.5 }}>
                    ...
                    <td>
                      <span className="admin-email">{new Date(aviso.timestamp).toLocaleDateString()}</span>
                    </td>

                    <td>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button className="admin-btn-salvar" style={{ padding: '4px 8px', fontSize: '11px' }} onClick={() => abrirEdicao(aviso)}>
                          Editar
                        </button>
                        <button
                          className="admin-btn-salvar"
