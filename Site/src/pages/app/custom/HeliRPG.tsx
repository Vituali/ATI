        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div className="attributes-grid">
              <div className="attribute-box" onClick={() => rollAttribute("Força", forca)}>
                ...
                <div className="attr-controls" onClick={e => e.stopPropagation()}>
                  <button className="attr-btn" onClick={() => setForca(prev => Math.max(0, prev - 1))}>-</button>
                  <button className="attr-btn" onClick={() => setForca(prev => Math.min(5, prev + 1))}>+</button>
                </div>
              </div>
              ...
              <div className="attribute-box" onClick={() => rollAttribute("Agilidade", agilidade)}>
                ...
                <div className="attr-controls" onClick={e => e.stopPropagation()}>
                  <button className="attr-btn" onClick={() => setAgilidade(prev => Math.max(0, prev - 1))}>-</button>
                  <button className="attr-btn" onClick={() => setAgilidade(prev => Math.min(5, prev + 1))}>+</button>
                </div>
              </div>
              ...
              <div className="attribute-box" onClick={() => rollAttribute("Intelecto", intelecto)}>
                ...
                <div className="attr-controls" onClick={e => e.stopPropagation()}>
                  <button className="attr-btn" onClick={() => setIntelecto(prev => Math.max(0, prev - 1))}>-</button>
                  <button className="attr-btn" onClick={() => setIntelecto(prev => Math.min(5, prev + 1))}>+</button>
                </div>
              </div>
              ...
              <div className="attribute-box" onClick={() => rollAttribute("Vigor", vigor)}>
                ...
                <div className="attr-controls" onClick={e => e.stopPropagation()}>
                  <button className="attr-btn" onClick={() => setVigor(prev => Math.max(0, prev - 1))}>-</button>
                  <button className="attr-btn" onClick={() => setVigor(prev => Math.min(5, prev + 1))}>+</button>
                </div>
              </div>
              ...
              <div className="attribute-box" onClick={() => rollAttribute("Presença", presenca)}>
                ...
                <div className="attr-controls" onClick={e => e.stopPropagation()}>
                  <button className="attr-btn" onClick={() => setPresenca(prev => Math.max(0, prev - 1))}>-</button>
                  <button className="attr-btn" onClick={() => setPresenca(prev => Math.min(5, prev + 1))}>+</button>
                </div>
              </div>
            </div>
            <p style={{ fontSize: "0.75rem", color: "#888", margin: 0, textAlign: "center" }}>
              💡 Clique no atributo para rolar os dados (Nd20) e pegar o maior!
            </p>
          </div>
          ...
          <div className="heli-card">
            ...
            <div className="dice-buttons">
              <button className="dice-btn" onClick={() => rollGeneric(4)}>d4</button>
              <button className="dice-btn" onClick={() => rollGeneric(6)}>d6</button>
              <button className="dice-btn" onClick={() => rollGeneric(8)}>d8</button>
              <button className="dice-btn" onClick={() => rollGeneric(10)}>d10</button>
              <button className="dice-btn" onClick={() => rollGeneric(12)}>d12</button>
              <button className="dice-btn" onClick={() => rollGeneric(20)}>d20</button>
              <button className="dice-btn" onClick={() => rollGeneric(100)}>d100</button>
            </div>
          </div>
          ...
          <div className="heli-card">
            ...
            <div className="rituals-list">
              {RITUAIS.map(ritual => (
                <div
                  key={ritual.name}
                  className={`ritual-item ${ritual.element}`}
                  onClick={ritual.roll}
                >
          ...
          <div className="heli-card">
            ...
            <div className="agent-status-section">
              ...
              <div className="status-bar-group">
                <div className="status-bar-header">
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <span>{pvAtual}/{pvMax}</span>
                    <button className="attr-btn" style={{ width: "16px", height: "16px", fontSize: "0.6rem" }} onClick={() => setPvMax(prev => Math.max(1, prev - 1))}>-</button>
                    <button className="attr-btn" style={{ width: "16px", height: "16px", fontSize: "0.6rem" }} onClick={() => setPvMax(prev => prev + 1)}>+</button>
                  </div>
                </div>
                ...
                <div className="status-adjust-row">
                  <button className="adjust-btn" onClick={() => setPvAtual(p => Math.max(0, p - 1))}>-1 PV</button>
                  <button className="adjust-btn" onClick={() => setPvAtual(p => Math.max(0, p - 5))}>-5 PV</button>
                  <button className="adjust-btn" onClick={() => setPvAtual(p => Math.min(pvMax, p + 1))}>+1 PV</button>
                  <button className="adjust-btn" onClick={() => setPvAtual(p => Math.min(pvMax, p + 5))}>+5 PV</button>
                </div>
              </div>
              ...
              <div className="status-bar-group">
                <div className="status-bar-header">
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <span>{sanAtual}/{sanMax}</span>
                    <button className="attr-btn" style={{ width: "16px", height: "16px", fontSize: "0.6rem" }} onClick={() => setSanMax(prev => Math.max(1, prev - 1))}>-</button>
                    <button className="attr-btn" style={{ width: "16px", height: "16px", fontSize: "0.6rem" }} onClick={() => setSanMax(prev => prev + 1)}>+</button>
                  </div>
                </div>
                <div className="status-bar-bg">
                ...
                <div className="status-adjust-row">
                  <button className="adjust-btn" onClick={() => setSanAtual(s => Math.max(0, s - 1))}>-1 SAN</button>
                  <button className="adjust-btn" onClick={() => setSanAtual(s => Math.max(0, s - 5))}>-5 SAN</button>
                  <button className="adjust-btn" onClick={() => setSanAtual(s => Math.min(sanMax, s + 1))}>+1 SAN</button>
                  <button className="adjust-btn" onClick={() => setSanAtual(s => Math.min(sanMax, s + 5))}>+5 SAN</button>
                </div>
              </div>
              ...
              <div className="status-bar-group">
                <div className="status-bar-header">
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <span>{peAtual}/{peMax}</span>
                    <button className="attr-btn" style={{ width: "16px", height: "16px", fontSize: "0.6rem" }} onClick={() => setPeMax(prev => Math.max(1, prev - 1))}>-</button>
                    <button className="attr-btn" style={{ width: "16px", height: "16px", fontSize: "0.6rem" }} onClick={() => setPeMax(prev => prev + 1)}>+</button>
                  </div>
                </div>
                <div className="status-bar-bg">
                ...
                <div className="status-adjust-row">
                  <button className="adjust-btn" onClick={() => setPeAtual(e => Math.max(0, e - 1))}>-1 PE</button>
                  <button className="adjust-btn" onClick={() => setPeAtual(e => Math.min(peMax, e + 1))}>+1 PE</button>
                </div>
              </div>
            </div>
            ...
            <div className="nex-control-row">
              ...
              <div className="nex-input-wrap">
                ...
                <button className="nex-btn" onClick={() => setNex(prev => Math.max(0, prev - 5))}>-</button>
                <span className="nex-val">{nex}%</span>
                <button className="nex-btn" onClick={() => setNex(prev => Math.min(99, prev + 5))}>+</button>
              </div>
            </div>
          </div>
            ...
            <div className="roll-history-container">
              {historico.length === 0 ? (
                <div className="roll-history-empty">
                  Nenhuma manifestação paranormal registrada... Rola os dados!
                </div>
              ) : (
                historico.map(entry => (
