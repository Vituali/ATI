      ...
      <div className="ci-mensagens">
        {mensagens.length === 0 && (
          <div className="ci-vazio">
            ...
            <p>
              A sala {getSetorLabel(activeRoom)} está vazia. Comece a conversa!
            </p>
          </div>
        )}
      ...
      <div className="ci-input-area">
        <div className="ci-input-wrapper">
          <textarea
            ref={inputRef}
            className="ci-input"
            placeholder={`Falar em ${getSetorLabel(activeRoom)}…`}
            value={texto}
