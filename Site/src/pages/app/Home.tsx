    ...
    <div className="home-page">
      ...
      <div className="home-hero">
        ...
        <div className="home-avatar-wrap">
          <div className="home-avatar">{user.avatarUrl ? <img src={user.avatarUrl} alt="Avatar" className="home-avatar-img" /> : inicial}</div>
      ...
      {pendente && (
        <div className="home-aviso">
          ...
          <div>
            ...
            <p>
              Sua conta foi criada, mas você ainda está no setor <strong>Geral</strong>. Um administrador precisa atribuir seu setor para liberar as demais funcionalidades.
            </p>
          </div>
        </div>
      )}
