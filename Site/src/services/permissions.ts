...
export const canViewOthersData = (role: Role) => ['supervisor', 'moderador', 'admin'].includes(role)
export const canManageUsers = (role: Role) => role === 'admin'
export const canEditOthersContent = (role: Role) => ['moderador', 'admin'].includes(role)
