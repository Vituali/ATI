      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="auth-grupo">
            ...
            <input id="usernameOrEmail" name="usernameOrEmail" type="text" placeholder="seu.usuario ou email@exemplo.com" value={usernameOrEmail} onChange={(e) => setUsernameOrEmail(e.target.value)} required autoFocus />
          </div>
